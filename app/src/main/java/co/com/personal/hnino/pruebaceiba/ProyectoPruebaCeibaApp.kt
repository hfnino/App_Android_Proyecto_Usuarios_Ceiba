package co.com.personal.hnino.pruebaceiba
...
open class ProyectoPruebaCeibaApp: Application() {// Esta clase extiende de Application(), lo que significa que
    // contamos con el contexto general de la aplicacion si la necesitaramos. Una clase de tipo Application
    // es una que extiende de la propia aplicacion de Android, por lo que  normalmente son las primeras en
